! function (e) {
    ...
    (t = n(4)(!1)).push([e.i, ".simple-tree-table-icon{display:inline-block;line-height:1.5em;padding-left:.5rem;text-align:center;cursor:pointer;font-size:16px}.simple-tree-table-closed .simple-tree-table-icon:after{content:'+'}\n .simple-tree-table-opened .simple-tree-table-icon:after{content:'-'}", ""]), e.exports = t
}, function (e, t, n) {
    "use strict";
